...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_EVENTO: 'evento/PARTIAL_UPDATE_EVENTO',
...
export default (state: EventoState = initialState, action): EventoState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_EVENTO):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_EVENTO):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_EVENTO):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IEvento> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_EVENTO,
